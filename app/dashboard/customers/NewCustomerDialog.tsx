...
export default function NewCustomerDialog({
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    setError(null);
    try {
      await customersApi.create({ fullName, email, phone, customerType });
      setFullName("");
      setEmail("");
      setPhone("");
      onCreated();
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-vault-950/40 px-4">
      <div className="w-full max-w-md rounded-lg bg-white p-6 shadow-xl">
        <div className="mb-5 flex items-center justify-between">
          <h3 className="font-display text-lg font-semibold text-vault-950">New customer</h3>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <Field label="Phone" value={phone} onChange={setPhone} placeholder="+855..." />
          <div>
